...
if len( sys.argv ) < 7:
    print 'Usage: run_ireg_baseline_nonlinear_in_mni.py <threads> <study> <field_strength> <viscode> <transformation> <spacing>'
    exit()
...
output_folder = adni.make_dir( data_folder, 'MNI152_linear_followup_to_baseline_' + trans + '_' + sx + 'mm')
