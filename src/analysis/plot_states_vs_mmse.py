...
#     ages_mci, mmses_mci, states_mci = read_data(datafile_bl, ['EMCI', 'LMCI'])
    ...
    # print 'CN:  ', stats.stats.pearsonr(mmses_cn, states_cn)
    # print 'MCI: ', stats.stats.pearsonr(mmses_mci, states_mci)
    print 'AD:  ', stats.stats.pearsonr(mmses_ad, states_ad)

    print 'Pearson CC: Disease state // Age'
    # print 'CN:  ', stats.stats.pearsonr(ages_cn, states_cn)
    # print 'MCI: ', stats.stats.pearsonr(ages_mci, states_mci)
    print 'AD:  ', stats.stats.pearsonr(ages_ad, states_ad)
    ...
    print 'Pearson CC: Disease state // MMSE'
    print 'AD:  ', stats.stats.pearsonr(mmses_ad, states_ad_regressed)

    print 'Pearson CC: Disease state // Age'
    print 'AD:  ', stats.stats.pearsonr(ages_ad, states_ad_regressed)
