...
import registration.ireg_nonlinear
...
sigma, weights, indices = at.adaptive_kernel_regression( ages, a.age, required_subjects = a.required_subjects )
...
class RegistrationThread(threading.Thread):
    ...
    def run(self):
        ...
        registration.ireg_nonlinear.run( source, target, 'none', out_dof, ireg_params, out_warped )

print 'Found ' + str(len( selected_images )) + ' relevant images for age ' + str(a.age) + '...'
thread_ctr = 0
threads = []
